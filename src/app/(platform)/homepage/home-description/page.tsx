...
import { DeleteHomeDescription } from "./(delete)/comp-delete";
  ...
  return (
    <div className="space-y-5 ">
      <div className="flex justify-between items-center">
        <h3 className="font-bold">Home Description</h3>
        <Link href="/homepage/home-description/create">
          <Button className="font-bold">Create Home Description</Button>
        </Link>
      </div>
        ...
        {data.map((item) => (
          <div key={item._id} className="border p-4 rounded-lg space-y-3">
            ...
            <div className="flex gap-2">
              <Link href={`/homepage/home-description/edit/${item._id}`}>
                <Button>Edit</Button>
              </Link>
              <DeleteHomeDescription id={item._id} />
            </div>
          </div>
        ))}
      </div>
